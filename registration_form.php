...
<div id="container">
  <div id="container_body">
    ...
    <div id="form_name">
      ...
      <div id="email">
        <input type="email" name="email" value="" placeholder="Your Email" class="input_email">
      </div>
      <div id="Re_email_form">
        <input type="text" name="confirm_email" value="" placeholder="Re-enter Email" class="input_Re_email">
      </div>
      <div id="password_form">
       ...
       <div>
        <input type="Submit" name="register_button" value="Register" onClick="register.php">
